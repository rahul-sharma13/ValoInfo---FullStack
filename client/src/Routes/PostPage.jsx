...
const PostPage = () => {
    ...
    useEffect(() => {
        const fetchPost = async () => {
            try {
                setLoading(true);
                await axios.get(`${import.meta.env.VITE_BASE_API_URL}/post/getposts?slug=${slug}`).then((res) => {
    ...
    const handleLikePost = async (postId) => {
        try {
            ...
            await axios.put(`${import.meta.env.VITE_BASE_API_URL}/post/upvote/${postId.toString()}`, { userId: currentUser._id }, { withCredentials: true }).then((res) => {
                // console.log(res);
                setPost(
                    {
                        ...post,
