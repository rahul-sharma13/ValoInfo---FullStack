...
const OAuth = () => {
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            await axios.post("https://valo-info-api.vercel.app/api/v1/auth/googlesignin", { name: resultsFromGoogle.user.displayName, email: resultsFromGoogle.user.email }, { withCredentials: true }).then((response) => {
