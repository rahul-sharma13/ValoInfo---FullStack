...
const PostsTab = () => {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        setLoading(true);
        await axios.get(`${import.meta.env.VITE_BASE_API_URL}/post/getuserposts/${currentUser._id}`, { withCredentials: true, credentials: 'include' }).then((res) => {
          // console.log(res);
          setLoading(false);
  ...
  const handleShowMore = async () => {
    ...
    try {
      await axios.get(`${import.meta.env.VITE_BASE_API_URL}/post/getuserposts/${currentUser._id}?startIndex=${startIndex}`, { withCredentials: true, credentials: 'include' }).then((res) => {
  ...
  const handleDeletePost = async (id) => {
    try {
      await axios.delete(`${import.meta.env.VITE_BASE_API_URL}/post/delete/${id}`, { withCredentials: true, credentials: "include" }).then((res) => {
        console.log(res);
